...
public class CatalogService {
    ...
    public List<GoodInfo> getGoodsByCategoryId(Long categoryId) {
        ...
        goods.add(new GoodInfo(1L, "Lorem 2014", "/images/m1.jpg", category, new BigDecimal(100)));
        goods.add(new GoodInfo(2L, "Lorem 2015", "/images/m2.jpg", category, new BigDecimal(200)));
        goods.add(new GoodInfo(3L, "Lorem 2016", "/images/m3.jpg", category, new BigDecimal(200)));
        goods.add(new GoodInfo(4L, "Rolex 2015", "/images/m4.jpg", category, new BigDecimal(300)));
        goods.add(new GoodInfo(5L, "Rolex 2016", "/images/m5.jpg", category, new BigDecimal(300)));
        goods.add(new GoodInfo(6L, "OMEGA 2015", "/images/m6.jpg", category, new BigDecimal(250)));
        return goods;
    }
